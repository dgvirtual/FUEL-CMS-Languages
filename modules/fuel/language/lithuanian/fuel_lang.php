...
|--------------------------------------------------------------------------
*/
$lang['fuel_page_title'] = 'FUEL TVS';
$lang['logged_in_as'] = 'Prisijungta:';
$lang['logout'] = 'Atsijungti';
$lang['fuel_developed_by'] = 'FUEL TVS (turinio valdymo sistemos) versiją %1s sukūrė <a href="http://www.thedaylightstudio.com" target="_blank">Daylight Studio</a>, ji sukurta  <a href="http://www.codeigniter.com" target="_blank">CodeIgniter</a> PHP programavimo aplinkos pagrindu.';
$lang['fuel_copyright'] = 'Autorinės teisės &copy; %1s Daylight Studio. Visos teisės saugomos.';
...
|--------------------------------------------------------------------------
*/
$lang['error_no_access'] = 'Jūs neturite prieigos prie šio puslapio. <a href="%1s">Pamėginkite prisijungti iš naujo</a>.';
$lang['error_missing_module'] = "Trūksta modulio %1s.";
$lang['error_invalid_login'] = 'Neteisingas prisijungimas.';
$lang['error_max_attempts'] = 'Deja, Jūsų prisijungimo informacija buvo neteisinga ir Jūs laikinai negalėsite prisijungti. Bandyti iš naujo galėsite po %s sekundžių.';
$lang['error_empty_user_pwd'] = 'Įrašykite vartotojo vardą ir slaptažodį.';
$lang['error_pwd_reset'] = 'Bandant pakeisti slaptažodį įvyko klaida.';

$lang['error_pwd_too_short'] = 'Įvestas slaptažodis neatitinka minimalaus %1s ženklų reikalavimo.';
$lang['error_pwd_too_long'] = 'Įrašytas slaptažodis viršija %1s ženklų maksimalaus ilgio reikalavimą.';
$lang['error_pwd_invalid'] = 'Pamėginkite įvesti stipresnį slaptažodį. Pamėginkite sumaišyti %1s.';


$lang['error_invalid_email'] = 'Pateiktas el. pašto adresas nėra užregistruotas sistemoje.';
$lang['error_invalid_password_match'] = 'Slaptažodžiai neatitinka.';
$lang['error_empty_email'] = 'Įrašykite el. pašto adresą.';
$lang['error_folder_not_writable'] = 'Turite padaryti aplanką %1s atvirą įrašymui.';
$lang['error_invalid_folder'] = 'Neteisingas aplankas %1s';
$lang['error_file_already_exists'] = 'Failas %1s jau egzistuoja.';
$lang['error_zip'] = 'Klaida kuriant zip archyvo failą.';
$lang['error_no_permissions'] = 'Neturite leidimų užbaigti šiam veiksmui. <a href="%1s">Mėginkite prisijungti iš naujo</a>.';
$lang['error_no_lib_permissions'] = 'Jūs neturite teisės vykdyti klasės %1s metodų.';
$lang['error_page_layout_variable_conflict'] = 'Išdėstymo klaida; šis išdėstymas arba neegzistuoja, arba jame yra vienas ar keletas rezervuotų žodžių: %1s';
$lang['error_no_curl_lib'] = 'Norint naudoti šiuos įrankius turi būti įdiegtas PHP curl praplėtimas.';
$lang['error_inline_page_edit'] = 'Šis kintamasis turi būti arba išsaugotas administratoriaus sąsajoje, arba redaguojamas susijusiuose views/_variables faile.';
$lang['error_saving'] = 'Klaida įrašant.';
$lang['error_cannot_preview'] = 'Bandant peržiūrėti šį puslapį įvyko klaida.';
$lang['error_cannot_make_api_call'] = 'Atliekant API šaukinį į %1s įvyko klaida.';
$lang['error_sending_email'] = 'Klaida bandant išsiųsti el. laišką į %1s.';
$lang['error_upload'] = 'Įkeliant failą įvyko klaida. Prašom įsitikinti, kad serverio nustatymai leidžia įkelti tokio dydžio failus, ir kad aplankas, į kurį bandoma įkelti, prieinamas įrašymui.';
$lang['error_create_nav_group'] = 'Prašom sukurti Navigacijos grupę';
$lang['error_requires_string_value'] = 'Vardo laukas turi būti eilutės (string) tipo';
$lang['error_missing_params'] = 'Šio puslapio peržiūrėjimui trūksta parametrų';
$lang['error_invalid_method'] = 'Neteisingas metodo pavadinimas';
$lang['error_curl_page'] = 'Klaida įkeliant puslapį su CURL';
$lang['error_class_property_does_not_exist'] = 'Klasės kintamasis %1s neegzistuoja';
...
$lang['error_no_build'] = "Šiam moduliui nėra konstravimo nustatymų.\n";
$lang['error_invalid_record'] = "Įrašas apie modulį neegzistuoja.";
...
|--------------------------------------------------------------------------
*/
$lang['warn_change_default_pwd'] = '<strong>Labai rekomendoujame pakeisti numatytąjį <em>%1s</em></strong> slaptažodį į kitokį.';
$lang['warn_not_published'] = 'Šis elementas nėra paskelbtas.';
$lang['warn_not_active'] = 'Šis %1s nėra aktyvus.';
...
$lang['dev_pwd_instructions'] = 'Ši svetainė šiuo metu kuriama, prie jos jungiantis reikia įvesti slaptažodį.';
$lang['login_forgot_pwd'] = 'Pamiršote slaptažodį?';
$lang['login_reset_pwd'] = 'Nustatyti naują slaptažodį';
$lang['login_btn'] = 'Prisijungti';
$lang['logout_restore_original_user'] = 'Atkurti pirminį vartotoją';

$lang['auth_log_pass_reset_request'] = "Gautas slaptažodžio atkūrimo prašymas dėl '%1s' nuo %2s";
$lang['auth_log_pass_reset'] = "Slaptažodžio atkūrimo prašymas dėl '%1s' nuo %2s";
